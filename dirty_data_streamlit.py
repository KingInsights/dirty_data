...
if st.button("✅ Apply Changes"):
    ...
    user_choices = {}  # Assuming user_choices has been defined earlier

    # Check if there are any columns with -99999 placeholders
    placeholder = -99999
    columns_with_placeholder = [col for col in df.columns if (df[col] == placeholder).any()]
    ...
    if columns_with_placeholder:
        ...
        # If no placeholders are found, show this message
